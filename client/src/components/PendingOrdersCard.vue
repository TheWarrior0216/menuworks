...
<template>
    <div class="bg-light mb-2 p-3 mt-3">
        ...
        <div class="mt-4 text-center">
            <button @click="completedOrder(orderProp.id)" class="btn btn-success pending-order-buttons">Complete
                Order</button>
        </div>
        <div class="mt-3 text-center">
            <button @click="cancelOrder(orderProp.id)" class="btn btn-danger pending-order-buttons">Cancel
                Order</button>
        </div>
    </div>
</template>
