...
<template>
    <div class="bg-light mb-2 p-3">
        ...
        <p v-if="orderProp.isCancelled" class="bg-danger rounded border-primary text-center p-2 text-white mt-3 mb-0 ">
            Canceled</p>

        <p v-else-if="orderProp.completed" class="bg-success rounded border-primary text-center p-2 text-white mt-3 mb-0 ">Completed</p>
        <p v-else class="bg-primary rounded border-primary text-center p-2 text-white mt-3 mb-0 ">
            in Progress</p>
    </div>
</template>
